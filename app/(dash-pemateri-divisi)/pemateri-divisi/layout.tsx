    ...
    <div className="flex min-h-screen flex-col">
      ...
      {/* <div className="bg-background bg-cover bg-top bg-no-repeat  dark:bg-none md:bg-left md:py-4 lg:min-h-[100svh]">
        <div className="grid flex-1 gap-12 sm:container md:grid-cols-[200px_1fr] ">
          ...
          <main className="overflow-auto sm:flex sm:w-full sm:flex-1 sm:flex-col">
            {children}
          </main>
        </div>
      </div> */}
      ...
      {/* <section
        ...
        className="fixed inset-x-0 bottom-0 z-10 block bg-white shadow sm:hidden"
      >
        <div id="tabs" className="flex justify-between">
          <a
            href="#"
            className="inline-block w-full justify-center pb-1 pt-2 text-center hover:text-teal-500 focus:text-teal-500"
          >
            <svg
              width="25"
              height="25"
          ...
          <a className="inline-block w-full justify-center pb-1 pt-2 text-center hover:text-teal-500 focus:text-teal-500">
            <svg
              width="25"
              height="25"
              viewBox="0 0 42 42"
